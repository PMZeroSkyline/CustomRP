...
public class CustomLightEditor : LightEditor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            EditorGUILayout.HelpBox(light.type == LightType.Directional ? "Culling Mask only affects shadows." : "Culling Mask only affects shadow unless Use Light Per Objects is on.", MessageType.Warning);
        }
    }
