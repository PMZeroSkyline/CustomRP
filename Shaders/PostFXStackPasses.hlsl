...
float3 ColorGradingShadowsMidtonesHighlights(float3 color, bool useACES)
{
    ...
    return color * _SMHShadows.rgb * shadowsWeight + color * _SMHMidtones.rgb * midtonesWeight + color * _SMHHightlights.rgb * hightlightsWeight;
}
...
float4 RescalePassFragment (Varyings input) : SV_TARGET {
    if (_CopyBicubic) {
